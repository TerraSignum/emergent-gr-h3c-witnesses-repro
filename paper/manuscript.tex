...
\paragraph{Structural argument and empirical certification.}
...
unification reported above. Empirical certification of the
$\alpha_{\xi}^{2}$ rate on the eight-regime
canonical-physics ladder
$N\!\in\!\{50,64,72,84,100,128,200,300\}$ is bootstrap-
robust: free-fit $\hat\alpha\!=\!0.8136$ matches $81/100$
at $0.44\%$ relative residual, the bootstrap-CI$_{95\%}$
$[0.76, 1.02]$ contains $\alpha_{\xi}^{2}$ at $0.5\sigma$
from the bootstrap mean, and the AICc model comparison
places $\alpha_{\xi}^{2}$ among the five structural
rationals indistinguishable from the free fit at
$\Delta\mathrm{AICc}\!<\!0.1$. The cross-observable
identification with $\Lambda_{t}^{\rm mat}\!=\!81/100$ on
P4's branch-resolved cosmological-tensor row (matter side
of the chirality flip) picks $\alpha_{\xi}^{2}$ uniquely
among the five empirically-equivalent rationals as the
\emph{single structural choice} consistent with two
independent cosmological-tensor and chirality-spectral
audits. What remains analytically open is a specific
propagator-step identification mapping the spectral-step
factor in $w_{q,i},w_{l,i}$ onto an explicit P3 loop-class
insertion, plus an explicit sup-over-$N$-nodes saturation
bound for $S(N)$; the empirical-cross-observable closure
above is registered as the structural verdict pending
that identification.
